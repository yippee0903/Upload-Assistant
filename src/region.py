...
async def get_service(
    ...
    services = {
        ...
        'YT': 'YT', 'ZDF': 'ZDF', 'iP': 'iP', 'BBC iPlayer': 'iP', 'iQ': 'iQ', 'iQIYI': 'iQ', 'IQIYI': 'iQ', 'iT': 'iT', 'iTunes': 'iT',
        ...
        'A3P': 'A3P', 'Atresplayer': 'A3P', 'ACORN': 'ACORN', 'Acorn TV': 'ACORN', 'AMCP': 'AMCP', 'AMC+': 'AMCP',
        'ANGL': 'ANGL', 'Angel Studios': 'ANGL', 'ARTE': 'ARTE', 'Arte': 'ARTE', 'BB': 'BB', 'BritBox': 'BB',
        ...
        'NTAH': 'NTAH', 'National Theatre At Home': 'NTAH', 'OSN': 'OSN', 'OSN+': 'OSN', 'OXGN': 'OXGN', 'Oxygen': 'OXGN',
        'PLYR': 'PLYR', 'Player': 'PLYR', 'SAINA': 'SAINA', 'Saina Play': 'SAINA', 'SF': 'SF', 'SF Anytime': 'SF',
        'SHDR': 'SHDR', 'Shudder': 'SHDR', 'SKSH': 'SKSH', 'Sky Show': 'SKSH', 'SKSP': 'SKSP', 'Sky Sport': 'SKSP',
        'SKSTR': 'SKSTR', 'Sky Store': 'SKSTR', 'SLNG': 'SLNG', 'Sling TV': 'SLNG', 'SNXT': 'SNXT', 'Sun NXT': 'SNXT',
        'SS': 'SS', 'Simply South': 'SS', 'STMZ': 'STMZ', 'Streamz': 'STMZ', 'STZP': 'STZP', 'STARZPLAY': 'STZP',
        'TK': 'TK', 'Tentkotta': 'TK', 'UNXT': 'UNXT', 'U-NEXT': 'UNXT', 'VDO': 'VDO', 'Vidio': 'VDO',
        'VIU': 'VIU', 'Viu': 'VIU', 'VLD': 'VLD', 'Videoland': 'VLD', 'VMX': 'VMX',
        'VTRN': 'VTRN', 'VET Tv': 'VTRN', 'WTCH': 'WTCH', 'Watcha': 'WTCH', 'YOUKU': 'YOUKU', 'YoukuTV': 'YOUKU',
        'ZEE5': 'ZEE5', 'Zee5': 'ZEE5'
    }  # fmt: off
