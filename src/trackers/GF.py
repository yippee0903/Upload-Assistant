...
class GF(FrenchTrackerMixin, UNIT3D):
    ...
    _TITLE_CASE_LOWER = frozenset({
        ...
        'for', 'from', 'into', 'like', 'near', 'off',
        'over', 'past', 'than', 'with', 'upon', 'via',
    ...
    def _get_french_audio_label(self, meta: dict[str, Any]) -> str:
        ...
        _CODEC_MAP = {
            "DTS": "DTS", "AAC": "AAC", "AAC LC": "AAC",
            "AC-3": "DD", "E-AC-3": "DD+", "A_EAC3": "DD+",
            "Enhanced AC-3": "DD+", "MLP FBA": "TrueHD",
            "FLAC": "FLAC", "Opus": "Opus", "Vorbis": "VORBIS",
            "PCM": "LPCM", "LPCM Audio": "LPCM",
            "Dolby Digital Audio": "DD", "Dolby Digital Plus Audio": "DD+",
            "Dolby Digital Plus": "DD+", "Dolby TrueHD Audio": "TrueHD",
            "DTS Audio": "DTS", "DTS-HD Master Audio": "DTS-HD MA",
            "DTS-HD High-Res Audio": "DTS-HD HRA", "DTS:X Master Audio": "DTS:X",
        }
        ...
        _COMMERCIAL = {
            ...
            "DTS-HD High": "DTS-HD HRA", "Free Lossless Audio Codec": "FLAC",
        ...
        channel_layout = str(
            fr_track.get('ChannelLayout', '')
            or fr_track.get('ChannelLayout_Original', '')
            or fr_track.get('ChannelPositions', '')
        )
